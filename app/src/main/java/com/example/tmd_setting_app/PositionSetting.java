...
public class PositionSetting extends AppCompatActivity {
    ...
    final static String filename = "PositionSetting.txt";
    //public String output = "";
    List<String> output_pos = new ArrayList<String>();
    String [] txt_input_pos = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(start_num == 0){
            ...
            if(TextUtils.isEmpty(temp_input)){
                ...
                txt_input_pos = temp_input.split(",");
                for(int i = 0; i<txt_input_pos.length; i++){
                    items.add(txt_input_pos[i]);
                }
        ...
        addButton.setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                ...
                AlertDialog.Builder alert = new AlertDialog.Builder(PositionSetting.this);
                alert.setTitle("Input Data Collection Position");
                alert.setMessage("ex)hand, chest, bag");
                final EditText name = new EditText(PositionSetting.this);
                alert.setView(name);
                alert.setPositiveButton("ok", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        inputPos = name.getText().toString();
                        items.add(inputPos);
                    }
                });
        ...
        saveButton.setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                ...
                String[] tempstr = output_pos.toArray(new String[output_pos.size()]);
                String temp_output = "";
                ...
                Intent intent = new Intent(PositionSetting.this, MainActivity.class);
